											...
											<div class="col-md-10 col-sm-10 col-xs-8">
												<div class="input-group" style="margin-top: 5px;">
													<input type="checkbox" class="form-check-input" id="show_paid" name="show_paid" 
														<c:choose>
				    										<c:when test="${showPaid}">checked="checked"</c:when>
				  										</c:choose>    
													/>									
												</div>
											</div>
										...
										<div class="form-group ">
											...
											<div class="col-md-10 col-sm-10 col-xs-8">
												<div class="input-group">
													...
													<input class="form-control" id="show_from" name="show_from" placeholder="DD/MM/YYYY" type="text" 
														<c:choose>
				    										<c:when test="${showFrom != null}">value="${showFrom}"</c:when>
				  										</c:choose>    
													/>
												</div>
											</div>
